 ...
 */
public class TireFRPressure extends BaseMeasurement<PSI> {
    private final static Range<PSI> RANGE =
        new Range<PSI>(new PSI(0),
                new PSI(25));
    public final static String ID = "TirePrssFR";

    public TireFRPressure(Number value) {
        super(new PSI(value), RANGE);
    }
    public TireFRPressure(PSI value) {
        super(value, RANGE);
    }
