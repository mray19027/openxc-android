 ...
 */
public class TireRRPressure extends BaseMeasurement<PSI> {
    private final static Range<PSI> RANGE =
        new Range<PSI>(new PSI(0),
                new PSI(25));
    public final static String ID = "TirePrssRR";

    public TireRRPressure(Number value) {
        super(new PSI(value), RANGE);
    }
    public TireRRPressure(PSI value) {
        super(value, RANGE);
    }
