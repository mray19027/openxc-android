...
public abstract class BaseMeasurement<TheUnit extends Unit>
    ...
    static {
        ...
        try {
            cacheMeasurementId(TireFLPressure.class);
            cacheMeasurementId(TireFRPressure.class);
            cacheMeasurementId(TireRLPressure.class);
            cacheMeasurementId(TireRRPressure.class);
            cacheMeasurementId(TireFLStatus.class);
            cacheMeasurementId(TireFRStatus.class);
            cacheMeasurementId(TireRLStatus.class);
            cacheMeasurementId(TireRRStatus.class);
